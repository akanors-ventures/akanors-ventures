					...
					<div className="md:hidden reveal">
						<div className="flex flex-col items-center gap-3 max-w-xs mx-auto">
							...
							<div className="grid grid-cols-2 gap-3 w-full">
								{/* Wathīqah */}
								<div className="bg-card border border-border rounded-2xl flex flex-col items-center justify-center gap-1.5 py-5 px-3 shadow-lg hover:border-primary/50 transition-all group">
									<img
